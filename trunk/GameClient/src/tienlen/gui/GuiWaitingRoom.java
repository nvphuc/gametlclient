...
import tienlen.gui.component.MyJScrollPane;
import tienlen.gui.component.MyPanel;
import tienlen.gui.component.Table;
import tienlen.processor.ProcessorGuiWaitRoom;
...
public class GuiWaitingRoom extends Gui {
	...
	public GuiWaitingRoom(Game game, Point location) {
		...
		setGui();
		Thread thread = new Thread((ProcessorGuiWaitRoom) processor);
		thread.start();
	}
	...
	public void setGui() {
		...
		((ProcessorGuiWaitRoom) processor).updateTables();
	...
	public void actionPerformed(ActionEvent e) {
		ProcessorGuiWaitRoom processor = (ProcessorGuiWaitRoom) this.processor;
